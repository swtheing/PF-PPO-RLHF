...
st = "Read the following function signature and docstring, and fully implement the function described. Your response should only contain the code for this function."
...
for key, pos_r in pos.items():
    if len(neg[key]) > 0:
        nobj = {}
        nobj["instruction"] = st + remove_template(key)
        fp_2.write(nobj) 
    all_right = False
    print("pos:")
